...
//2. Loop through usernames in user object array
//3. loop through titles in book object array
//4. if both targets exist, print rating for user at that title
//input: username, title, array of users objects, array of book objects, num of users, num of books
...
int getRating(string username, string title, User users[], Book books[], int usersnum, int booksnum){
    ...
    for(int i = 0; i < usersnum; i++){ //loop through usernames in user array
        string usernew = "";
    ...
    for (int j = 0; j < booksnum; j++){ //loop through titles in book array
        string titlenew = "";
        string word = books[j].getTitle();
...
int main(){
    ...
    User users[5];
    Book books[5];
    int rating = getRating("User1", "Title2", users, books,  0, 0);
    cout << rating;
